...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:bg-neutral-100 disabled:from-neutral-100 disabled:to-neutral-100 border border-neutral-200 shadow-sm",
  {
    variants: {
      variant: {
        // test: "bg-green-500 text-red-500",
        primary:
          "bg-gradient-to-b from-blue-600 to-blue-700 text-primary-foreground hover:from-blue-700 hover:to-blue-700",//to-b ,to bottom
        destructive:
        ...
        secondary:
          "bg-red text-black hover:bg-neutral-100",
