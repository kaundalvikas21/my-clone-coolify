...
export const DataKanban = ({
    ...
    const onDragEnd = useCallback((result: DropResult) => {
        ...
        setTasks((prevTasks) => {
            ...
            //  If there's is no moved task (shouldn't happen but just in case), return the previous state.
           if(!movedTask) {
        ...
        // Update position for affected task in the destination column
        ...
        // if the task moved b/w columns,  update position in the source column
